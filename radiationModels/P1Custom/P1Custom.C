...
namespace Foam
{
    namespace radiation
    {
        defineTypeNameAndDebug(P1Custom, 0);
        addToRadiationRunTimeSelectionTables(P1Custom);
    }
}
...
Foam::radiation::P1Custom::P1Custom(const volScalarField& T)
:
...
Foam::radiation::P1Custom::P1Custom(const dictionary& dict, const volScalarField& T)
:
...
bool Foam::radiation::P1Custom::read()
{
...
void Foam::radiation::P1Custom::calculate()
{
...
Foam::tmp<Foam::volScalarField> Foam::radiation::P1Custom::Rp() const
{
...
Foam::radiation::P1Custom::Ru() const
{
...
Foam::label Foam::radiation::P1Custom::nBands() const
{
