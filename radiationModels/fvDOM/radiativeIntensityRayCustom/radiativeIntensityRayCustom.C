...
#include "radiativeIntensityRayCustom.H"
#include "fvm.H"
...
const Foam::word
Foam::radiation::radiativeIntensityRayCustom::intensityPrefix("ILambda");


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::radiation::radiativeIntensityRayCustom::radiativeIntensityRayCustom
(
...
Foam::scalar Foam::radiation::radiativeIntensityRayCustom::correct()
{
...
void Foam::radiation::radiativeIntensityRayCustom::addIntensity()
{
