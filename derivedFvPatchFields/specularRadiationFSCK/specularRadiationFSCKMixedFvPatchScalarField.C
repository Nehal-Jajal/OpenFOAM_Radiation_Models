...
#include "specularRadiationFSCKMixedFvPatchScalarField.H"
...
scalar specularRadiationFSCKMixedFvPatchScalarField::azimuthAngle
(
    const vector& d
) const
{
...
scalar specularRadiationFSCKMixedFvPatchScalarField::polarAngle
(
    const vector& d
) const
{
...
tmp<scalarField> specularRadiationFSCKMixedFvPatchScalarField::interpolateI
(
    const fvDOM_FSCK& dom,
...
label specularRadiationFSCKMixedFvPatchScalarField::calcComplementaryRayID
(
    const fvDOM_FSCK& dom
) const
{
...
specularRadiationFSCKMixedFvPatchScalarField::
specularRadiationFSCKMixedFvPatchScalarField
(
    const fvPatch& p,
...
specularRadiationFSCKMixedFvPatchScalarField
(
    const specularRadiationFSCKMixedFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
    ...
    interpolate_(dict.getOrDefault("interpolate", false))
{
    ...
    else
    {
        FatalErrorInFunction
            << " specularRadiationFSCK boundary condition is limited to "
...
void specularRadiationFSCKMixedFvPatchScalarField::updateCoeffs()
{
    if (this->updated())
    {
        return;
...
void specularRadiationFSCKMixedFvPatchScalarField::write(Ostream& os) const
{
