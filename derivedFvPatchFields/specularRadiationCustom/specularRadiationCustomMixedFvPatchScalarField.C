...
#include "specularRadiationCustomMixedFvPatchScalarField.H"
...
scalar specularRadiationCustomMixedFvPatchScalarField::azimuthAngle
(
    const vector& d
) const
{
...
scalar specularRadiationCustomMixedFvPatchScalarField::polarAngle
(
    const vector& d
) const
{
...
tmp<scalarField> specularRadiationCustomMixedFvPatchScalarField::interpolateI
(
    const fvDOMCustom& dom,
...
label specularRadiationCustomMixedFvPatchScalarField::calcComplementaryRayID
(
    const fvDOMCustom& dom
) const
{
...
specularRadiationCustomMixedFvPatchScalarField::
specularRadiationCustomMixedFvPatchScalarField
(
    const fvPatch& p,
...
specularRadiationCustomMixedFvPatchScalarField
(
    const specularRadiationCustomMixedFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
    ...
    interpolate_(dict.getOrDefault("interpolate", false))
{
    ...
    else
    {
        FatalErrorInFunction
            << " specularRadiationCustom boundary condition is limited to "
...
void specularRadiationCustomMixedFvPatchScalarField::updateCoeffs()
{
    if (this->updated())
    {
        return;
...
void specularRadiationCustomMixedFvPatchScalarField::write(Ostream& os) const
{
